# Mauricio Obando Portfolio



## Template variables

* `portfolio_mauricio` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `portfolio-mauricio` - executable or bundle name on disk.
* `Mauricio Obando Portfolio` - display name shown in window titles and about app dialogs.
* `com.flet` - org name in reverse domain name notation, e.g. `com.mycompany.myproject`.
* `Mauricio Obando` - the name of the company.
