...
5. Run `uv run python -m portfolio_app.scripts.build_frontend_content` after curated content or generated JSON changes so the Flutter app picks up the latest payload.
